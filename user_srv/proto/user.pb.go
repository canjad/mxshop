...
type CheckResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Check         bool                   `protobuf:"varint,1,opt,name=check,proto3" json:"check,omitempty"` // true:密码正确 false:密码错误
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserListResponse struct {
	...
	UserList      []*UserInfoResponse    `protobuf:"bytes,2,rep,name=userList,proto3" json:"userList,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_proto_rawDesc = "" +
	...
	"\x05check\x18\x01 \x01(\bR\x05check\"0\n" +
	"\bPageInfo\x12\x0e\n" +
	...
	"\buserList\x18\x02 \x03(\v2\x11.UserInfoResponseR\buserList2\xb5\x02\n" +
	"\x04User\x12+\n" +
...
var file_user_proto_depIdxs = []int32{
	7, // 0: UserListResponse.userList:type_name -> UserInfoResponse
